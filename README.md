...
[20. AWS CICD: CodeCommit, CodePipeline, CodeBuild, CodeDeploy](#cicd)
[21. AWS Serverless: SAM - Serverless Application Model](#serverless)
[22. Cloud Development Kit](#cdk)
[23. Cognito: Cognito User Pools, Cognito Identity Pools and Cognito Sync](#cognito)
[24. Other Serverless : Step Functions and AppSync](#appfunction)
[25. Advanced Identity](#advanceidentity)
[26. AWS Security and Encryption : KMS, Encryption SDK, SSM Parameter store, IAM and STS](#securityandencryption)
[27. AWS Other Services](#otherservices)
[28. AWS Final Cleanup](#cleanup)
[29. Preparing for the exam](#awscertified)
